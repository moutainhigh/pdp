...
import com.pd.pdp.server.core.complete.XxlJobCompleter;
...
import com.pd.pdp.server.core.scheduler.XxlJobScheduler;
import com.pd.pdp.server.core.util.I18nUtil;
import com.pd.pdp.server.mapper.XxlJobGroupDao;
import com.pd.pdp.server.mapper.XxlJobInfoDao;
import com.pd.pdp.server.mapper.XxlJobLogDao;
...
public class JobLogController {
	...
	@ResponseBody
	@ApiOperation(value = "根据执行器获取调度日志")
